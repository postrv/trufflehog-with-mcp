...
func ScanDirectoryTool() mcp.Tool {
	return mcp.NewTool("scan_directory",
		mcp.WithDescription("Scan a directory recursively for secrets and credentials. "+
			"Use this to check entire project folders, configuration directories, or any directory tree "+
